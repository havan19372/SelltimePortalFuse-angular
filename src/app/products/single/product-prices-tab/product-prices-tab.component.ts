...
@Component({
  selector: 'app-product-prices-tab',
  templateUrl: './product-prices-tab.component.html',
  styleUrls: ['./product-prices-tab.component.scss']
})
export class ProductPricesTabComponent implements OnInit {
